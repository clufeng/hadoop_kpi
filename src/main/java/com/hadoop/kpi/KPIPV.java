...
import com.hadoop.kpi.model.KPI;
...
public class KPIPV {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.setInputPaths(conf, new Path("/user/hdfs/log_kpi/"));
        FileOutputFormat.setOutputPath(conf, new Path("/user/hdfs/log_kpi/pv"));
